...
class TestPostDeerRequestVegetationInner(unittest.TestCase):
    """PostDeerRequestVegetationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostDeerRequestVegetationInner:
        ...
        # uncomment below to create an instance of `PostDeerRequestVegetationInner`
        """
        model = PostDeerRequestVegetationInner()
        if include_optional:
            return PostDeerRequestVegetationInner(
                vegetation = {
                    'key' : null
                    },
                deer_proportion = [
    ...
    def testPostDeerRequestVegetationInner(self):
        """Test PostDeerRequestVegetationInner"""
