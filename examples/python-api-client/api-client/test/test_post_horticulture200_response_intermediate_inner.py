...
class TestPostHorticulture200ResponseIntermediateInner(unittest.TestCase):
    """PostHorticulture200ResponseIntermediateInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostHorticulture200ResponseIntermediateInner:
        ...
        # uncomment below to create an instance of `PostHorticulture200ResponseIntermediateInner`
        """
        model = PostHorticulture200ResponseIntermediateInner()
        if include_optional:
            return PostHorticulture200ResponseIntermediateInner(
                id = '',
                scope1 = {
                    'key' : null
                    },
    ...
    def testPostHorticulture200ResponseIntermediateInner(self):
        """Test PostHorticulture200ResponseIntermediateInner"""
