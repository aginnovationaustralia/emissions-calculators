...
json = "{}"
# create an instance of PostWildcatchfishery200ResponseScope1 from a JSON string
post_wildcatchfishery200_response_scope1_instance = PostWildcatchfishery200ResponseScope1.from_json(json)
# print the JSON string representation of the object
print(PostWildcatchfishery200ResponseScope1.to_json())

# convert the object into a dict
post_wildcatchfishery200_response_scope1_dict = post_wildcatchfishery200_response_scope1_instance.to_dict()
# create an instance of PostWildcatchfishery200ResponseScope1 from a dict
post_wildcatchfishery200_response_scope1_from_dict = PostWildcatchfishery200ResponseScope1.from_dict(post_wildcatchfishery200_response_scope1_dict)
```
