...
**type** | **str** | Crop type. Note that the following crop types are now deprecated, the relevant full calculator should be used instead: &#39;Cotton&#39;, &#39;Rice&#39;, &#39;Sugar Cane&#39; | 
...
**production_system** | **str** | Production system of this crop. Note that the following production systems are now deprecated, the relevant full calculator should be used instead: &#39;Cotton&#39;, &#39;Rice&#39;, &#39;Sugar cane&#39; | 
...
json = "{}"
# create an instance of PostGrainsRequestCropsInner from a JSON string
post_grains_request_crops_inner_instance = PostGrainsRequestCropsInner.from_json(json)
# print the JSON string representation of the object
print(PostGrainsRequestCropsInner.to_json())

# convert the object into a dict
post_grains_request_crops_inner_dict = post_grains_request_crops_inner_instance.to_dict()
# create an instance of PostGrainsRequestCropsInner from a dict
post_grains_request_crops_inner_from_dict = PostGrainsRequestCropsInner.from_dict(post_grains_request_crops_inner_dict)
```
