...
json = "{}"
# create an instance of PostBeefRequestBeefInnerClassesHeifers1To2Traded from a JSON string
post_beef_request_beef_inner_classes_heifers1_to2_traded_instance = PostBeefRequestBeefInnerClassesHeifers1To2Traded.from_json(json)
# print the JSON string representation of the object
print(PostBeefRequestBeefInnerClassesHeifers1To2Traded.to_json())

# convert the object into a dict
post_beef_request_beef_inner_classes_heifers1_to2_traded_dict = post_beef_request_beef_inner_classes_heifers1_to2_traded_instance.to_dict()
# create an instance of PostBeefRequestBeefInnerClassesHeifers1To2Traded from a dict
post_beef_request_beef_inner_classes_heifers1_to2_traded_from_dict = PostBeefRequestBeefInnerClassesHeifers1To2Traded.from_dict(post_beef_request_beef_inner_classes_heifers1_to2_traded_dict)
```
