...
post_buffalo200_response_scope1_instance = PostBuffalo200ResponseScope1.from_json(json)
# print the JSON string representation of the object
print(PostBuffalo200ResponseScope1.to_json())

# convert the object into a dict
post_buffalo200_response_scope1_dict = post_buffalo200_response_scope1_instance.to_dict()
# create an instance of PostBuffalo200ResponseScope1 from a dict
post_buffalo200_response_scope1_from_dict = PostBuffalo200ResponseScope1.from_dict(post_buffalo200_response_scope1_dict)
```
