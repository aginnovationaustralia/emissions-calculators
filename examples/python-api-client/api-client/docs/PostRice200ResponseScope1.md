...
**rice_cultivation_ch4** | **float** | CH4 emissions from rice cultivation, in tonnes-CO2e | 
...
json = "{}"
# create an instance of PostRice200ResponseScope1 from a JSON string
post_rice200_response_scope1_instance = PostRice200ResponseScope1.from_json(json)
# print the JSON string representation of the object
print(PostRice200ResponseScope1.to_json())

# convert the object into a dict
post_rice200_response_scope1_dict = post_rice200_response_scope1_instance.to_dict()
# create an instance of PostRice200ResponseScope1 from a dict
post_rice200_response_scope1_from_dict = PostRice200ResponseScope1.from_dict(post_rice200_response_scope1_dict)
```
