...
**savannah_burning_n2_o** | **float** | N2O emissions from field burning, in tonnes-CO2e | 
**savannah_burning_ch4** | **float** | CH4 emissions from field burning, in tonnes-CO2e | 
...
json = "{}"
# create an instance of PostBeef200ResponseScope1 from a JSON string
post_beef200_response_scope1_instance = PostBeef200ResponseScope1.from_json(json)
# print the JSON string representation of the object
print(PostBeef200ResponseScope1.to_json())

# convert the object into a dict
post_beef200_response_scope1_dict = post_beef200_response_scope1_instance.to_dict()
# create an instance of PostBeef200ResponseScope1 from a dict
post_beef200_response_scope1_from_dict = PostBeef200ResponseScope1.from_dict(post_beef200_response_scope1_dict)
```
