...
**manure_management_direct_n2_o** | **float** | CH4 emissions from manure management (direct), in tonnes-CO2e | 
**atmospheric_deposition_n2_o** | **float** | N2O emissions from atmospheric deposition, in tonnes-CO2e | 
**atmospheric_deposition_indirect_n2_o** | **float** | N2O emissions from atmospheric deposition indirect, in tonnes-CO2e | 
**leaching_and_runoff_soil_n2_o** | **float** | N2O emissions from leeching and runoff, in tonnes-CO2e | 
**leaching_and_runoff_mmsn2_o** | **float** | N2O emissions from leeching and runoff, in tonnes-CO2e | 
...
json = "{}"
# create an instance of PostPork200ResponseScope1 from a JSON string
post_pork200_response_scope1_instance = PostPork200ResponseScope1.from_json(json)
# print the JSON string representation of the object
print(PostPork200ResponseScope1.to_json())

# convert the object into a dict
post_pork200_response_scope1_dict = post_pork200_response_scope1_instance.to_dict()
# create an instance of PostPork200ResponseScope1 from a dict
post_pork200_response_scope1_from_dict = PostPork200ResponseScope1.from_dict(post_pork200_response_scope1_dict)
```
