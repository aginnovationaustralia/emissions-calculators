...
import { DeerClasses } from './deerclasses.input';
import { DoesFawningProportion } from './fawningproportion.input';
import { SeasonalFawningRates } from './seasonalfawning.input';

export class DeerComplete {
  @IsString()
  @IsOptional()
  ...
  @ValidateNested({ always: true })
  @Type(() => DoesFawningProportion)
  @IsDefined()
  doesFawning!: DoesFawningProportion;

  @ValidateNested({ always: true })
  @Type(() => SeasonalFawningRates)
  @IsDefined()
  seasonalFawning!: SeasonalFawningRates;
}
