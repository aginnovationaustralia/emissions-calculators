...
import { HorticultureCropType, HorticultureCropTypes } from '../types';
import { HorticultureRefrigerant } from './refrigerant.input';

export class HorticultureCrop {
  @IsString()
  @IsOptional()
  @SchemaDescription(DESCRIPTIONS.ACTIVITY_ID)
  id?: string;

  @IsEnum(HorticultureCropTypes)
  @SchemaDescription('Crop type')
  @IsDefined()
  type!: HorticultureCropType;

  @IsNumber()
  @SchemaDescription('Average crop yield, in t/ha (tonnes per hectare)')
  @IsDefined()
  averageYield!: number;
  ...
  @IsBoolean()
  @IsOptional()
  @DeprecatedSchemaDescription('No longer used (since v1.1.0)')
  ...
  @TypeWithArraySchema(() => HorticultureRefrigerant)
  @ValidateNested({ always: true, each: true })
  @IsDefined()
  refrigerants!: HorticultureRefrigerant[];
}
