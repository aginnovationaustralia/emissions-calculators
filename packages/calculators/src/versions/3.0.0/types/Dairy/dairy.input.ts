...
export const DairyCompleteSchema = z.object({
  ...
  emissionsAllocationToRedMeatProduction: z.number().min(0).max(1).meta({
    description: 'Allocation as a fraction, from 0 to 1',
  }),
  truckType: z
    .enum(TruckTypes)
