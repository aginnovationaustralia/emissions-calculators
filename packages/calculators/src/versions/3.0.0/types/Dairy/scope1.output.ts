...
export class DairyScope1Output {
  @IsNumber()
  ...
  @IsNumber()
  @SchemaDescription('N2O emissions from animal waste, in tonnes-CO2e')
  @IsDefined()
  ...
  @IsNumber()
  @SchemaDescription(OUTPUTDESCRIPTIONS.urineDungN2O)
  @IsDefined()
  ...
  @IsNumber()
  @SchemaDescription(OUTPUTDESCRIPTIONS.transportN2O)
  @IsDefined()
  transportN2O!: number;

  @IsNumber()
  @SchemaDescription(OUTPUTDESCRIPTIONS.transportCH4)
  @IsDefined()
  transportCH4!: number;

  @IsNumber()
  @SchemaDescription(OUTPUTDESCRIPTIONS.transportCO2)
  @IsDefined()
  transportCO2!: number;
