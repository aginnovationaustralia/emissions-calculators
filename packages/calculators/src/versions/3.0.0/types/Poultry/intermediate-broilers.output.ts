...
import { PoultryEmissionsIntensitiesBroiler } from './intensities-broiler.output';
import { PoultryScope1Output } from './scope1.output';
import { PoultryScope3Output } from './scope3.output';

export class PoultryIntermediateBroilersOutput extends BaseScopesOutput {
  @IsString()
  @IsDefined()
  id!: string;
  ...
  @ValidateNested({ always: true })
  @Type(() => PoultryEmissionsIntensitiesBroiler)
  @IsDefined()
  intensities!: PoultryEmissionsIntensitiesBroiler;
