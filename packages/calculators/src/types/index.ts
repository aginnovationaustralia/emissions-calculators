...
export {
  ...
  Fuels,
  GoatClassesAPI,
  HorticultureCropType,
  HorticultureCropTypes,
  ...
  VegetationClass,
  VegetationClasses,
  VegetationClassNumber,
  WaterRegimeSubType,
  WaterRegimeSubTypes,
  WaterRegimeType,
  WaterRegimeTypes,
  WildCatchFisheryBait,
  WildSeaFisheriesBait,
  WildSeaFisheriesBaits,
...
export { createOpenApiSchemaFile, openapiSchemas } from './openapi';
