...
export const ProcessingScope1OutputSchema = z
  .object({
    ...
    purchasedCO2: z
      .number()
      .meta({ description: OUTPUTDESCRIPTIONS.purchasedCO2 }),
    wastewaterCO2: z
      .number()
...
export type ProcessingScope1Output = z.infer<
  typeof ProcessingScope1OutputSchema
>;
