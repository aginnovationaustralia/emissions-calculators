export const DESCRIPTIONS = {
  ELECTRICITY_PURCHASED:
    'Amount of electricity purchased from the grid in KWh (kilowatt hours)',
  RECS_SURRENDERED:
    'Number of eligible Renewable Energy Certificates voluntarily surrendered in the reporting year equivalent to megawatt hours (MWh)',
  RECS_ONSITE:
    'Number eligible Renewable Energy Certificates that have been or will be issued for electricity produced on-site during the year and consumed by the entity equivalent to megawatt hours (MWh)',
...
export const OUTPUTDESCRIPTIONS = {
  ...
  fuelTransportCO2: et1('CO2', 'fuel transport'),
  fuelTransportCH4: et1('CH4', 'fuel transport'),
  fuelTransportN2O: et1('N2O', 'fuel transport'),
  fuelStationaryCO2: et1('CO2', 'fuel stationary'),
  fuelStationaryCH4: et1('CH4', 'fuel stationary'),
  fuelStationaryN2O: et1('N2O', 'fuel stationary'),
  ...
  manureManagementCH4: et1('CH4', 'manure management'),
  manureManagementN2O: et1('N2O', 'manure management'),
  fertiliserUseN2O: et1('N2O', 'fertiliser use'),
  agricultureResidueManagementN2O: et1('N2O', 'agriculture residue management'),
  transportFuelCO2: et1('CO2', 'transport fuel'),
  transportFuelCH4: et1('CH4', 'transport fuel'),
  transportFuelN2O: et1('N2O', 'transport fuel'),
  stationaryFuelCO2: et1('CO2', 'stationary fuel'),
  stationaryFuelCH4: et1('CH4', 'stationary fuel'),
  stationaryFuelN2O: et1('N2O', 'stationary fuel'),
  solidWasteTreatmentN2O: et1('N2O', 'solid waste treatment'),
  ...
  pastureResidueN2O: et1('N2O', 'pasture residue'),
  ...
  purchasedMineralSupplements:
    'Emissions from purchased mineral supplements, in tonnes-CO2e',
  purchasedFertiliser: 'Emissions from purchased fertiliser, in tonnes-CO2e',
  purchasedHay: 'Emissions from purchased hay, in tonnes-CO2e',
  purchasedAgrichemicals:
    'Emissions from purchased agrichemicals, in tonnes-CO2e',
  purchasedLime: 'Emissions from purchased lime, in tonnes-CO2e',
  purchasedServices:
    'Emissions from purchased services and contractors, in tonnes-CO2e',
  otherPurchasedGoodsAndServices:
    'Emissions from other purchased goods and services, in tonnes-CO2e',
  upstreamFuel: 'Emissions from upstream fuel, in tonnes-CO2e',
  upstreamElectricity: 'Emissions from upstream electricity, in tonnes-CO2e',
  managementOfWaste: 'Emissions from management of waste, in tonnes-CO2e',
  herbicide: 'Emissions from herbicide, in tonnes-CO2e',
  agrichemicals: 'Emissions from agrichemicals, in tonnes-CO2e',
  ...
  services: 'Emissions from purchased services and contractors, in tonnes-CO2e',
  offsiteManure: 'Emissions from offsite manure, in tonnes-CO2e',
  solidWaste: 'Emissions from solid waste, in tonnes-CO2e',
