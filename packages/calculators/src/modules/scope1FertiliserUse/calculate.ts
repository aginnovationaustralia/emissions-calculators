...
export const calculateScope1FertiliserUse = (
  ...
  const fertiliserN2O: Scope1Output<'N2O'> = scope1Output(
    'fertiliserN2O',
    zeroN2O,
  );
  const atmosphericDepositionN2O: Scope1Output<'N2O'> = scope1Output(
    'atmosphericDepositionN2O',
    zeroN2O,
  );
  const leachingAndRunoffN2O: Scope1Output<'N2O'> = scope1Output(
